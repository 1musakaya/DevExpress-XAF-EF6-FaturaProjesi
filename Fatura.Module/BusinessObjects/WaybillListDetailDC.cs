...
{
    [DomainComponent]
    public class WaybillListDetailDC : IXafEntityObject/*, IObjectSpaceLink*/, INotifyPropertyChanged
    {
        ...
        [Browsable(false)]
        public virtual WaybillListDC WaybillListDC { get; set; }
