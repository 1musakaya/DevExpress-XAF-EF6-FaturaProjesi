...
{
    [DomainComponent]
    public class PaymentListDetailDC : IXafEntityObject/*, IObjectSpaceLink*/, INotifyPropertyChanged
    {
        private void OnPropertyChanged([CallerMemberName] string propertyName = null)
        {
            PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(propertyName));
        }
        public PaymentListDetailDC()
        {
            Oid = Guid.NewGuid();
        }
        ...
        [Browsable(false)]
        public virtual PaymentListDC PaymentListDC { get; set; }
