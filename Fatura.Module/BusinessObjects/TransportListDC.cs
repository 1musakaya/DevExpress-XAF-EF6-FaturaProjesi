...
{
    [DomainComponent]
    public class TransportListDC : IXafEntityObject/*, IObjectSpaceLink*/, INotifyPropertyChanged
    {
        private void OnPropertyChanged([CallerMemberName] string propertyName = null)
        {
            PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(propertyName));
        }
        public TransportListDC()
        {
            Oid = Guid.NewGuid();
            StartDate= DateTime.Now.Date;
            EndDate= DateTime.Now.Date;
            //Details=new List<TransportListDetailDC>();
        }
        ...
        /*
        [Aggregated]
        public virtual IList<TransportListDetailDC> Details { get; set; }
        */
