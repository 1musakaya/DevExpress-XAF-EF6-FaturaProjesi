...
{
    [DomainComponent]
    public class ContactListDC : IXafEntityObject/*, IObjectSpaceLink*/, INotifyPropertyChanged
    {
        private void OnPropertyChanged([CallerMemberName] string propertyName = null)
        {
            PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(propertyName));
        }
        public ContactListDC()
        {
            Oid = Guid.NewGuid();
            ...
            Details=new List<ContactListDetailDC>();
        ...
        [Aggregated]
        public virtual IList<ContactListDetailDC> Details { get; set; }
