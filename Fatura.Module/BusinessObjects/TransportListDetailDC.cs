...
{
    [DomainComponent]
    public class TransportListDetailDC : IXafEntityObject/*, IObjectSpaceLink*/, INotifyPropertyChanged
    {
        private void OnPropertyChanged([CallerMemberName] string propertyName = null)
        {
            PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(propertyName));
        }
        public TransportListDetailDC()
        {
            Oid = Guid.NewGuid();
        }
        ...
        [Browsable(false)]
        public virtual TransportListDC TransportListDC { get; set; }
