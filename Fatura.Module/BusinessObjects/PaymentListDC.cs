...
{
    [DomainComponent]
    public class PaymentListDC : IXafEntityObject/*, IObjectSpaceLink*/, INotifyPropertyChanged
    {
        ...
        public PaymentListDC()
        {
            Oid = Guid.NewGuid();

            PaymentListDetailDC = new List<PaymentListDetailDC>();
        }
        ...
        [Aggregated]
        public virtual IList<PaymentListDetailDC> PaymentListDetailDC { get; set; }
