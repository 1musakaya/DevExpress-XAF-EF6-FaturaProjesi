...
{
    [DomainComponent]
    public class WaybillListDC : IXafEntityObject/*, IObjectSpaceLink*/, INotifyPropertyChanged
    {
        ...
        public WaybillListDC()
        {
            ...
            Details = new List<WaybillListDetailDC>();
        }
        ...
        [Aggregated]
        public virtual IList<WaybillListDetailDC> Details { get; set; }
